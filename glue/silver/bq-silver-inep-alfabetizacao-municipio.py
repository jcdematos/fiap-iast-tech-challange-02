...
JOB_NAME = args_disponiveis['JOB_NAME'] if args_disponiveis['JOB_NAME'] else "bq-silver-inep-alfabetizacao-municipio"
...
CHECKS = {
    "alunos": [
        ...
        {"tipo": "unique",    "coluna": "id_aluno",     "critico": True},
    ],
    ...
    "municipio": [
        {"tipo": "min_count", "valor": 1,               "critico": True},
        {"tipo": "not_null",  "coluna": "id_municipio", "critico": True},
        {"tipo": "not_null",  "coluna": "ano",          "critico": True}, # Garante que o ano não é nulo
    ],
    "uf": [
        {"tipo": "min_count", "valor": 1,               "critico": True},
        {"tipo": "not_null",  "coluna": "sigla_uf",     "critico": True},
...
# ============================================================
# FUNÇÃO DE VALIDAÇÃO DE QUALIDADE — [INCLUÍDO]
# ============================================================
...
for entidade_atual in tabelas_para_processar:
    ...
    try:
        ...
        # 2. Persistir em cache temporário
        df_silver.persist()
        ...
        # 4. Gravação unificada criando pastas limpas /ano_ingestao=YYYY/... no seu bucket S3
        df_silver.write \
        ...
        # Garante a liberação da memória se o DataFrame foi cacheado
